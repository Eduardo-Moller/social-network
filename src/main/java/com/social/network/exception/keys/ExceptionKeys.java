...
public class ExceptionKeys {
	...
	public static final String USERNAME_ALREADY_REGISTERED_CODE = "username.already.registered";
	public static final String UNAUTHORIZED_ERROR_CODE = "unauthorized.error";
	...
	public static final String USERNAME_ALREADY_REGISTERED_MESSAGE = "Nome de usuário já cadastrado";
	public static final String UNAUTHORIZED_ERROR_MESSAGE = "Usuário ou senha inválidos";
}
